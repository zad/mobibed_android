...
public abstract class MeasurementTask implements Callable<MeasurementResult>, Comparable {
  ...
  static {
    ...
    measurementTypes.put(MobiBedTask.TYPE, MobiBedTask.class);
    measurementDescToType.put(MobiBedTask.DESCRIPTOR, MobiBedTask.TYPE);
    measurementTypes.put(TCPTask.TYPE, TCPTask.class);
    measurementDescToType.put(TCPTask.DESCRIPTOR, TCPTask.TYPE);
  }
...
public String getContribUrl() {
	
	return this.measurementDesc.contrib_url;
}
}
