...
public class PingTask extends MeasurementTask {
  ...
  public static class PingDesc extends MeasurementDesc {
    ...
    public PingDesc(String key, Date startTime, Date endTime, double intervalSec, long count,
  ...
  public PingTask(MeasurementDesc desc, Context parent) {
    super(new PingDesc(desc.key, desc.startTime, desc.endTime, desc.intervalSec, desc.count,
  ...
  public MeasurementTask clone() {
    ...
    PingDesc newDesc = new PingDesc(desc.key, desc.startTime, desc.endTime, desc.intervalSec,
  ...
  private double filterPingResults(final ArrayList<Double> rrts, double avg) {
    ...
    try {
      ArrayList<Double> filteredResults = Util.applyInnerBandFilter(rrts, Double.MIN_VALUE, rrtAvg
          * Config.PING_FILTER_THRES);
